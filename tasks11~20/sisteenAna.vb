Private Sub Command1_Click() '404230
  ...
  loc_0040459F: If ebx <> 0 Then GoTo loc_00404EDE
  ...
  loc_00404791: var_8C = Mid$(var_84, CLng(var_6C), 2)
  loc_004047B4: var_ret_2 = CLng(var_6C + 1)
  loc_004047CC: var_90 = Mid$(var_88, var_ret_2, 1)
  loc_004047F6: edi = (var_8C = var_90) + 1
  loc_0040483B: If (var_8C = var_90) + 1 = 0 Then GoTo loc_00404874
  ...
  loc_00404941: If var_134 <> 0 Then GoTo loc_00404EDE
  ...
  loc_00404B70: var_8C = Hex$(Len(var_84))
  loc_00404B91: var_eax = TextBox.1784
  loc_00404BBC: var_38 = var_98
  loc_00404C5B: var_84 = Text1.Text
  loc_00404CBA: var_88 = Mid$(var_84, CLng(var_6C), 1)
  loc_00404CC3: var_100 = Asc(var_88)
  loc_00404CF1: var_34 = var_34 + Asc(var_88)
