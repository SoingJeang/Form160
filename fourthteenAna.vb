Private Sub Command1_Click() '403620
  ...
  loc_00403704: If var_2C <> 9 Then GoTo loc_00403A24 '失败
  loc_00403727: var_1C = Text1.Text
  loc_00403751: var_ret_1 = Len(var_1C) '长度
  loc_0040375A: var_EC = var_ret_1
  
  loc_0040377C: var_18 = 1
  loc_00403787: If var_18 > var_ret_1 Then GoTo loc_00403AA4 '成功 
  loc_004037AA: var_1C = Text1.Text
  loc_004037E5: var_24 = Text1.Text
  loc_00403831: var_28 = Mid$(var_24, vbNull, 1) 'Ansi(1,1)
  loc_00403859: var_20 = Mid$(var_1C, vbNull, 1) 'Ansi(1,1)
  loc_004038AD: If var_2C <> 0 Then GoTo loc_00403A22 '失败
                var_20 > 0
  loc_004038D3: var_1C = Text1.Text
  loc_00403909: var_58 = var_18 xor 0002h
  loc_0040391B: var_28 = Str$(var_58, 2) '前面放空
  loc_0040393F: var_20 = Mid$(var_1C, vbNull, 1) 'Ansi(1,1)
  loc_0040394B: var_48 = Asc(var_20)
  loc_0040397D: var_C8 = (Str$(Asc(var_20), 2) - 0x30.0)
  loc_00403997: var_68 = var_28
  loc_004039A5: var_80 = Right(var_28, 1)
                cmpare
  loc_00403A04: If (var_C8 <> var_80) <> 0 Then GoTo loc_00403A22 '失败
